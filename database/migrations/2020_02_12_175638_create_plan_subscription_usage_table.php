...
class CreatePlanSubscriptionUsageTable extends Migration {
	...
	public function up()
	{
		Schema::create(config('emeefe.subscriptions.tables.plan_subscription_usage'), function(Blueprint $table)
		{
	...
	{
		Schema::drop(config('emeefe.subscriptions.tables.plan_subscription_usage'));
	}
